...
import { RegisterUser, LoginUser, DashboardUser, LogoutUser, CreatePlaylist, GetPlaylists, DeletePlaylist, SearchSongs, AddSongToPlaylist, SongsInPlaylist } from "../controllers/user-controller.js";
...
router.get('/songsInPlaylist/:playlistId', verifyToken, SongsInPlaylist)
