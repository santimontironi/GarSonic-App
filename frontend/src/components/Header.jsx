...
const Header = () => {
  ...
  return (
    <header className="w-full h-[100px] flex justify-between bg-black items-center lg:pl-[50px] xl:pr-[50px] pl-[20px] pr-[20px] shadow-[4px_5px_20px_rgba(0,0,0,0.50)">
        ...
        <nav className={`${openNav ? "opacity-100 translate-x-0" : "opacity-0 translate-x-full"} transition-all duration-300 ease-in-out text-white list-none absolute top-0 right-0 w-[200px] p-[15px] h-[100vh] bg-black
