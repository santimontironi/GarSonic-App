...
const HeaderDashboardArtist = () => {
    ...
    return (
        <>
            ...
            <header
                className={`text-white h-screen w-[300px] p-[25px] bg-gradient-to-b from-black to-purple-700 shadow-[10px_25px_25px_rgba(0,0,0,0.50)] fixed top-0 left-0 transform transition-transform duration-300 z-40 ${openNav ? "translate-x-0 headerDashboard" : "-translate-x-full"} lg:translate-x-0`}>
                ...
                <nav>
                    <ul className="flex flex-col items-center gap-[45px]">
                        ...
                        <li>
                            <a className="inline-block text-center w-[150px] p-[10px] text-white font-bold rounded-2xl bg-purple-600 cursor-pointer hover:bg-purple-800 hover:scale-110 transition duration-200 ease-in-out" href="/mis-canciones">
                                Mis canciones
                            </a>
                        </li>
                        <li>
                            <a className="inline-block text-center w-[150px] p-[10px] text-purple-600 font-bold rounded-2xl bg-white cursor-pointer hover:scale-110 transition duration-200 ease-in-out" href="agregar-cancion">
                                Agregar canción
                            </a>
                        </li>
                        <li>
                        ...
                        <li className="flex flex-col items-center gap-[15px]">
                            ...
                            />
                            <span className="font-bold">{artistData?.artistName}</span>
                            <button
...
export default HeaderDashboardArtist