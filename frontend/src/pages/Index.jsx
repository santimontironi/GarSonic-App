...
const Index = () => {
  return (
    <>
      <section id="inicio" className="index-container w-full min-h-[calc(80vh-100px)] lg:h-[calc(100vh-120px)] md:h-[calc(80vh-100px)] bg-gradient-to-b from-purple-900 to-purple-700">
        <motion.div
